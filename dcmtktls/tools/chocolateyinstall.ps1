...
$url = 'https://dcmtk.org/chocolatey/dcmtk-3.6.6-win32-chocolatey-tls.zip' # download url
$url64 = 'https://dcmtk.org/chocolatey/dcmtk-3.6.6-win64-chocolatey-tls.zip' # download url
